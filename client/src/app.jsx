...
import ExistingStorage from './components/ExistingStorage';
  ...
  return (
    <div style={{ maxWidth: 860, margin: '0 auto', padding: '3rem 1.5rem 5rem' }}>
      ...
      <div className="fade-up delay-2">
        <CameraList cameras={cameras} onUpdate={updateCamera}
          onRemove={removeCamera} onAddGroup={addGroup} />
      </div>

      {/* Existing storage check */}
      <div className="fade-up delay-3">
        <ExistingStorage cameras={cameras} overhead={overhead} disabled={cameras.length === 0} />
      </div>
